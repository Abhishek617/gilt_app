...
final List<Hospital> hospitalInfo = [
  ...
  Hospital(
      ...
      description:
      'Snazzy, compact Japanese cafe showcasing high-end coffee & sandwiches, plus sake & beer.',
  ...
  Hospital(
      ...
      description:
      'Compact coffee & espresso bar turning out drinks made from direct-trade.',
