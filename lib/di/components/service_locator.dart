...
import 'package:guilt_app/data/network/apis/posts/post_api.dart';
...
import 'package:guilt_app/di/module/local_module.dart';
import 'package:guilt_app/di/module/network_module.dart';
...
Future<void> setupLocator() async {
  ...
  // api's:---------------------------------------------------------------------
  getIt.registerSingleton(PostApi(getIt<DioClient>(), getIt<RestClient>(),getIt<SharedPreferenceHelper>()));
